...
class Zodiac_Signs2 extends StatefulWidget {
  // String z1 = '';
  Zodiac_Signs2({
    Key ? key , 
    // required this.z1 ,
  ...
  @override
  State<Zodiac_Signs2> createState() => _Zodiac_Signs2State();
}

class _Zodiac_Signs2State extends State<Zodiac_Signs2> {
    ...
    child: Container(
      ...
      child: Column(children: [
        ...
        Container(
          ...
          width: w*0.4,
          child: 
        Center(child: ListTile(title: Center(child: Text(txt)), 
